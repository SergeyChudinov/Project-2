...
/* harmony import */ var _modules_addImg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/addImg */ "./src/js/modules/addImg.js");
/* harmony import */ var _modules_changeModalState__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/changeModalState */ "./src/js/modules/changeModalState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalState = {};
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_14__["default"])(modalState);
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]'); // showMoreStyles('.button-transparent', '.styles-2'); // 1-2

  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-transparent', '#styles .row'); // 3
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])('#accordion', '.accordion-block'); // 1
  ...
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_12__["default"])(modalState);
  Object(_modules_addImg__WEBPACK_IMPORTED_MODULE_13__["default"])();
});
...
var accordion = function accordion(accordionSelector, blockSelector) {
  // 1
  var accordionDiv = document.querySelector(accordionSelector);
  var accordionBlock = document.querySelectorAll(blockSelector);
  var span = document.querySelectorAll('.accordion-heading span');
  ...
  function hideText() {
    ...
    document.querySelectorAll('.accordion-heading').forEach(function (el) {
  ...
  ;
  hideText();
  accordionDiv.addEventListener('click', function (e) {
...
/* harmony default export */ __webpack_exports__["default"] = (accordion); // const accordion = (triggerSelector, itemsSelector) => {   // 2
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_requsets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/requsets */ "./src/js/services/requsets.js");
...
var addImg = function addImg() {
  ...
  addImgButton.addEventListener('click', function () {
    Object(_services_requsets__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/img').then(function (data) {
      if (data.length !== 0) {
        console.log(data);
        img.src = data[0].data;
      }
...
var changeModalState = function changeModalState(state) {
  var paintingSize = document.querySelector('#size');
  var paintingMaterial = document.querySelector('#material');
  var additionalOptions = document.querySelector('#options');
...
var drop = function drop(state) {
  ...
  function unhighlight(item) {
    item.closest('.file_upload').style.border = 'none'; // if (item.closest('.calc_form')) {
    ...
    input.addEventListener('drop', function (e) {
      ...
      reader.onloadend = function () {
        ...
        if (!input.closest('form')) {
          Object(_services_requsets__WEBPACK_IMPORTED_MODULE_3__["postData"])('http://localhost:3000/img', JSON.stringify(json));
        } else {
      ...
      var preview = input.parentNode.parentNode.querySelector('img');
...
/* harmony default export */ __webpack_exports__["default"] = (drop); // События претаскивания
// drag *
// dregend *
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (e.target.closest('li')) {
      ...
      wrapper.querySelectorAll(".".concat(classList)).forEach(function (item) {
        item.style.display = 'block';
        item.classList.add('animated', 'fadeIn');
      });
      menu.querySelector(".".concat(classList)).classList.add('active');
...
/* harmony default export */ __webpack_exports__["default"] = (filter); // const filter = () => {
...
/* harmony import */ var _services_requsets__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/requsets */ "./src/js/services/requsets.js");
...
var forms = function forms(state) {
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      ...
      var preview = item.parentNode.parentNode.querySelector('img');
      preview.src = '';
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var objFormData = Object.fromEntries(formData.entries()); // if (objFormData?.upload.name === '') {  // Нужно переписать через ?.
      //     delete  objFormData.upload;
      // }

      if ('upload' in objFormData) {
        // Нужно переписать через ?. ,Babel не дает
        if (objFormData.upload.name === '') {
          delete objFormData.upload;
        }
      }

      var json = JSON.stringify(objFormData);
      Object(_services_requsets__WEBPACK_IMPORTED_MODULE_8__["postData"])(api, json).then(function (data) {
        statusImg.setAttribute('src', message.ok); // statusImg.src = message.ok;

        textMessage.textContent = message.success;
      }).catch(function () {
        statusImg.setAttribute('src', message.fail); // statusImg.src = message.fail;
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); //нужно для стар брауз-ов, вставить после >= (и добавить -1)
  ...
  showModalByTime('.popup-consultation', 60000, calcScroll());
};
...
/* harmony import */ var _services_requsets__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../services/requsets */ "./src/js/services/requsets.js");
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    ...
    //удалил стрел функ, чотб работал this
    Object(_services_requsets__WEBPACK_IMPORTED_MODULE_6__["getResource"])('http://localhost:3000/styles') // getResource('assets/db.json')
    .then(function (res) {
